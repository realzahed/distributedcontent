...
public class admin_login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Admin Login " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (email.equals(db_email)) {
                    ...
                    if (pass.equals(db_pass)) {
                        ...
                        messageDetail = "Password does not match. Please check the password and try again";
            ...
            message = "Error Logging In";
                    messageDetail = "There was an error processing your Login. Please try after some time!";
