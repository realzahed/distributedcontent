                ...
                if (isEmailValid) {
                    if (pass.length() > 7) {
                        if (pass.equals(passAgain)) {
                            ...
                            String sql = "INSERT INTO  `dcac`.`user` "
                            ...
                            messageDetail = "Please check the password and try again.";
                            out.print(" Not Successful! Passwords do not match!");
                    ...
                    out.print(" Not Successful!! email is wrong");
                }
            }
            else {
                isRegistered = false;
