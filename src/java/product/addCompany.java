    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (companyName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany = "INSERT INTO  `dcac`.`product-company` (`company-id` ,`company-name`)VALUES (NULL ,  '"+companyName+"');";  
                ...
                out.println("Company With the Same Name Already Exists");
            }
