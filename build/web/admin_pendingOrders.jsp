    ...
    <div class="row">
     <div class="col-md-3">
            <div  id="sidebar-nav" class="list-group">
                ...
                <a href="admin_pendingOrders.jsp" style="background-color: #6e7f80;color: #fff;" class="list-group-item"><i class="fa fa-clock-o fa-lg fa-fw"></i> Pending Orders</a>
        ...
        <div class="col-md-9">
          ...
          <form class="form-horizontal" method="post" action="changeProductStatus">
             <h3 class="text-center">Pending Orders<small> Orders to be Approved</small></h3>
              <div class="form-group">
                <input type="submit" class="btn btn-bsu" value="Change Product Status">
                    <div class="col-sm-6">
                      <select class="form-control" name="ChangeStatus">
                        <option value="approved">Approve Orders</option>
                        <option value="cancel">Cancel Orders</option>
                      </select>
                    </div>
                  </div>
                  <h4 style ="text-align: center;">Order(s) To Be Approved</h4>  
                    <div class="table-responsive">
                      <table class="table table-bordered" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td><%= sold_on_date%></td>
                            <td><%= mobile_no%></td>
                            <td style="text-align: justify;"><strong><%= name%>,</strong><br> <%= address%></td>
                        </tr>
                        <%
                                }
                                oldOrder = newOrder;
