...
$(document).ready(function () {
    ...
    $('.showForm-signup').click(function () {
        $('#topLogin').hide();
        $('#adminLogin').hide();
        $('#signUp').slideToggle("slow");
    });
    $('.showForm-admin').click(function () {
        $('#signUp').hide();
        $('#topLogin').hide();
...
$(document).ready(function () {
    ...
    $('#addCategoryNameBtn').click(function () {
        ...
        if (categoryName === "") {
            $('#step2Feedback').html("Please Enter the Category Name");
            $('#step2Feedback').addClass("red");
            $('#step2Feedback').slideDown(500, function () {
                $('#step2Feedback').slideUp(10000, function () {
                });
            });
        } else {
            $.post('addCategory', {
    ...
    $('#addSubCategoryBtn').click(function () {
        var SubCategoryName = $('#SubCategoryName').val(), categoryName = $('#categoryName').val();
        if (categoryName === "") {
            categoryName = $('#selectMenuCategory').val();
        }
        if (SubCategoryName === "" || categoryName === "") {
            $('#step2Feedback1').html("Please Enter Sub-Category Name or Select Sub-Category name");
            $('#step2Feedback1').addClass("well-lg");
            $('#step2Feedback1').slideDown(700, function () {
                $('#step2Feedback1').slideUp(10000, function () {
                    location.reload();
                });
            });
        } else {
