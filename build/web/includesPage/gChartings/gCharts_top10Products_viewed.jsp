...
<!--Loading the AJAX API-->
    ...
    <div class="well-lg" style="border: 1px solid #d7e0e2;margin-top: 2%;margin-bottom: 2%;width: 920px; height: 420px;">
    ...
    <div id="chart_div_lineTop10" style="width: 890px; height: 380px;"></div>
