            ...
            %>                         
                <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p><%= company_name %> <span class="label label-primary pull-right" style="font-size: 100%;"><i class="fa fa-rupee"></i> <%= price %></span></p>
                      ...
                      <p class="text-center"><a href="admin_manageProduct.jsp?pid=<%= product_id %>" style="float: left;" class="btn btn-warning btn-embossed btn-sm">Edit Product</a></p>
                    </div>
