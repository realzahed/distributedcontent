    ...
    <div class="row">
         <div class="col-md-3"> 
            <div id="sidebar-nav" class="list-group">
                ...
                <a href="admin_deliveredOrders.jsp" class="list-group-item list-group-item-success"><i class="fa fa-truck fa-lg fa-fw"></i> Delivered Orders</a>
          ...
          <div class="lead">
            ...
            <form class="form-horizontal" method="post" action="changeProductStatus">
                <h3 class="text-center">Delivered Orders</h3>
                  <h4 style ="text-align: center;">Order(s) Delivered</h4>  
